...
* Paxos Made Switch-y [[pdf](https://www.sigcomm.org/sites/default/files/ccr/papers/2016/April/0000000-0000002.pdf)]
* NetPaxos: consensus at network speed [[acmdl](https://dl.acm.org/citation.cfm?id=2774999)]
* Consensus in a Box: Inexpensive Coordination in Hardware [[pdf](https://www.usenix.org/system/files/conference/nsdi16/nsdi16-paper-istvan.pdf)]
* Ring Paxos: A high-throughput atomic broadcast protocol [[pdf](https://ieeexplore.ieee.org/document/5544272)]
* Multi-Ring Paxos [[pdf](https://ieeexplore.ieee.org/document/6263916)]
* Taming uncertainty in distributed systems with help from the network [[pdf](http://www.cs.utexas.edu/falcon/papers/albatross-eurosys2015.pdf)]
...
* Derecho: Fast State Machine Replication for Cloud Services [[acmdl](https://dl.acm.org/citation.cfm?id=3302258)]
* Just say NO to Paxos Overhead: Replacing Consensus with Network Ordering [[pdf](https://www.usenix.org/system/files/conference/osdi16/osdi16-li.pdf)]
* AllConcur: Leaderless Concurrent Atomic Broadcast [[pdf](https://spcl.inf.ethz.ch/Publications/.pdf/poke2017allconcur.pdf)]
* DARE: High-Performance State Machine Replication on RDMA Networks [[pdf](https://spcl.inf.ethz.ch/Research/Parallel_Programming/DARE/dare-TR.pdf)]
* P4xos: Consensus as a Network Service [[pdf](http://web.inf.usi.ch/file/pub/105/p4xos.pdf)]
  * P4xos is also evaluated in "The Case For In-Network Computing On Demand" [[pdf](https://www.inf.usi.ch/faculty/soule/pubs/eurosys2019.pdf)]
...
* MDCC: Multi-Data Center Consistency [[pdf](http://mdcc.cs.berkeley.edu/mdcc.pdf)]
* Canopus: A Scalable and Massively Parallel Consensus Protocol [[pdf](https://cs.uwaterloo.ca/~bernard/Canopus.pdf)]
* There Is More Consensus in Egalitarian Parliaments [[pdf](https://www.cs.cmu.edu/~dga/papers/epaxos-sosp2013.pdf)]
* DPaxos: Managing Data Closer to Users for Low-Latency and Mobile Applications [[pdf](https://nawab.me/Uploads/Nawab_DPaxos_SIGMOD2018.pdf)]
* SDPaxos: Building Efficient Semi-Decentralized Geo-replicated State Machines [[pdf](https://www.microsoft.com/en-us/research/publication/sdpaxos-building-efficient-semi-decentralized-geo-replicated-state-machines/)]
...
* Mencius: Building Efficient Replicated State Machines for WANs [[pdf](https://www.usenix.org/legacy/event/osdi08/tech/full_papers/mao/mao.pdf)]
* Geo-replicated storage with scalable deferred update replication [[pdf](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.724.1706&rep=rep1&type=pdf)]
...
* Scalable Consistency in Scatter [[pdf](https://homes.cs.washington.edu/~tom/pubs/scatter.pdf)]
* GlobalFS: A Strongly Consistent Multi-Site File System [[pdf](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7794339)]
* CalvinFS: Consistent WAN Replication and Scalable Metadata Management for Distributed File Systems [[pdf](https://www.usenix.org/system/files/conference/fast15/fast15-paper-thomson.pdf)]
* Low-Latency Multi-Datacenter Databases using Replicated Commit [[pdf](http://www.vldb.org/pvldb/vol6/p661-mahmoud.pdf)]
...
* Zab: High-performance broadcast for primary-backup systems [[pdf](https://knowably-attachments.s3.amazonaws.com/u/55b69a1ce4b00ab397d67250/7c8734d3cf02154499a9b3161ef9f575/Zab_2011.pdf)]
...
* PaxosStore: High-availability Storage Made Practical in WeChat [[pdf](http://www.vldb.org/pvldb/vol10/p1730-lin.pdf)]
* Windows Azure Storage: a highly available cloud storage service with strong consistency [[acmdl](https://dl.acm.org/citation.cfm?id=2043571)]
...
* Replication and fault-tolerance in the ISIS system [[pdf](https://ecommons.cornell.edu/handle/1813/6508)]
...
* S-Paxos: Offloading the Leader for High Throughput State Machine Replication [[pdf](https://infoscience.epfl.ch/record/179912/files/2012_SPaxos-CameraReady.pdf)]
* Optimizing Paxos with batching and pipelining [[pdf](https://infoscience.epfl.ch/record/189440/files/TCS.pdf)]
* Paxos for System Builders: An Overview [[pdf](http://www.cnds.jhu.edu/pub/papers/psb_ladis_08.pdf)]
* Partitioned Paxos via the Network Data Plane [[pdf](https://arxiv.org/abs/1901.08806meni)]
* The SMART Way to Migrate Replicated Stateful Services [[pdf](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/eurosys2006.pdf)]
* Boxwood: Abstractions as the Foundation for Storage Infrastructure [[pdf](https://www.usenix.org/legacy/event/osdi04/tech/full_papers/maccormick/maccormick.pdf)]
* Replication in the Harp File System [[pdf](http://www.pmg.csail.mit.edu/papers/harp.pdf)]
* CORFU: A Distributed Shared Log [[acmdl](https://dl.acm.org/citation.cfm?id=2535930)]
* Tango: Distributed data structures over a shared log [[pdf](http://www.cs.cornell.edu/~taozou/sosp13/tangososp.pdf)]
* The Farsite Project: A Retrospective [[pdf](https://www.microsoft.com/en-us/research/wp-content/uploads/2007/04/OSR2007-4aa.pdf)]
* Using Paxos to Build a Scalable, Consistent, and Highly Available Datastore [[acmdl](https://dl.acm.org/citation.cfm?id=1938549)]
* Paxos replicated state machines as the basis of a high-performance data store [[acmdl](https://dl.acm.org/citation.cfm?id=1972472)]
* Granola: Low-Overhead Distributed Transaction Coordination [[pdf](https://www.usenix.org/system/files/conference/atc12/atc12-final118.pdf)]
* Making Fast Consensus Generally Faster [[pdf](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7579738)]
* Scalable State-Machine Replication [[pdf](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=6903591)]
...
* Paxos made transparent [[acmdl](https://dl.acm.org/citation.cfm?doid=2815400.2815427)]
* Designing Distributed Systems Using Approximate Synchrony in Data Center Networks [[pdf](https://syslab.cs.washington.edu/papers/specpaxos-nsdi15.pdf)]
* No compromises: distributed transactions with consistency, availability, and performance [[pdf](https://pdos.csail.mit.edu/6.824/papers/farm-2015.pdf)]
* Building Consistent Transactions with Inconsistent Replication [[pdf](https://irenezhang.net/papers/tapir-sosp15.pdf)]
...
* The Performance of Paxos in the Cloud [[pdf](https://www.cs.cornell.edu/projects/Quicksilver/public_pdfs/SRDS14.pdf)]
...
* Implementing Fault-Tolerant Services Using the State Machine Approach: A Tutorial [[pdf](https://www.cs.cornell.edu/fbs/publications/SMSurvey.pdf)]
* Linearizability: A Correctness Condition for Concurrent Objects [[pdf](https://cs.brown.edu/~mph/HerlihyW90/p463-herlihy.pdf)]
* Implementing Linearizability at Large Scale and Low Latency [[acmdl](https://dl.acm.org/citation.cfm?id=2815416)]
* Cheap and Available State Machine Replication [[pdf](https://www.usenix.org/system/files/conference/atc16/atc16_paper-shi.pdf)]

### Weaker consistency models
This section lists papers which discuss alternative consistency models to Linearizability.
* Existential Consistency: Measuring and Understanding Consistency at Facebook [[pdf](http://sigops.org/s/conferences/sosp/2015/current/2015-Monterey/printable/240-lu.pdf)]
* What consistency does your key-value store actually provide? [[pdf](https://www.usenix.net/legacy/events/hotdep10/tech/full_papers/Anderson.pdf)]
  * offline consistency checking of key-value traces
* TAO: Facebook’s Distributed Data Store for the Social Graph [[pdf](https://www.usenix.org/system/files/conference/atc13/atc13-bronson.pdf)]
* Consistency in Non-Transactional Distributed Storage Systems [[pdf](http://www.vukolic.com/consistency-survey.pdf)]
* Dynamo: Amazon’s Highly Available Key-value Store [[pdf](https://www.allthingsdistributed.com/files/amazon-dynamo-sosp2007.pdf)]
* Bigtable: A Distributed Storage System for Structured Data [[pdf](https://static.googleusercontent.com/media/research.google.com/en//archive/bigtable-osdi06.pdf)]
...
* Towards Robust Distributed Systems [[pdf](https://people.eecs.berkeley.edu/~brewer/cs262b-2004/PODC-keynote.pdf)]
  * PODC keynote in which Eric Brewer proposed the now infamous CAP theorem
* Quantifying eventual consistency with PBS [[pdf](http://www.bailis.org/papers/pbs-vldbj2014.pdf)]
* Eventual Consistency Today: Limitations, Extensions, and Beyond [[pdf](https://queue.acm.org/detail.cfm?id=2462076)]
...
* Benchmarking Cloud Serving Systems with YCSB [[pdf](https://www2.cs.duke.edu/courses/fall13/compsci590.4/838-CloudPapers/ycsb.pdf)]
...
* Leases: An Efficient Fault-Tolerant Mechanism for Distributed File Cache Consistency [[pdf](https://web.stanford.edu/class/cs240/readings/89-leases.pdf)]
...
* The Network is Reliable: An informal survey of real-world communications failures [[pdf](https://queue.acm.org/detail.cfm?id=2655736)]
* Communication Costs in Real-world Networks [[pdf](http://www.bailis.org/blog/communication-costs-in-real-world-networks/)]
* What Bugs Live in the Cloud? A Study of 3000+ Issues in Cloud Systems [[pdf](https://ucare.cs.uchicago.edu/pdf/socc14-cbs.pdf)]
* Understanding Network Failures in Data Centers: Measurement, Analysis, and Implications [[pdf](http://conferences.sigcomm.org/sigcomm/2011/papers/sigcomm/p350.pdf)]
* Teaching Rigorous Distributed Systems With Efficient Model Checking [[acmdl](https://dl.acm.org/citation.cfm?id=3303947)]
* Lineage-driven Fault Injection [[pdf](https://people.ucsc.edu/~palvaro/molly.pdf)]
...
* IronFleet: Proving Practical Distributed Systems Correct [[pdf](http://sigops.org/s/conferences/sosp/2015/current/2015-Monterey/printable/250-hawblitzel.pdf)]
...
* Specifying Systems: The TLA+ Language and Tools for Hardware and Software Engineers [[pdf](https://lamport.azurewebsites.net/tla/book-02-08-08.pdf)]
* Modeling Paxos and Flexible Paxos in Pluscal and TLA+ [[pdf](http://muratbuffalo.blogspot.com/2016/11/modeling-paxos-and-flexible-paxos-in.html)]
...
* Weighted Voting for Replicated Data [[pdf](http://pages.cs.wisc.edu/~remzi/Classes/739/Fall2015/Papers/gifford79.pdf)]
* An Efficient and Fault-tolerant Solution for Distributed Mutual Exclusion [[pdf](https://users.soe.ucsc.edu/~scott/courses/Fall11/221/Papers/Sync/agrawal-tocs91.pdf)]
* The Generalized Tree Quorum Protocol: An Efficient Approach for Managing Replicated Data [[acmdl](https://dl.acm.org/citation.cfm?id=146935)]
* The Reliability of Voting Mechanisms [[pdf](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=1676860)]
* The grid protocol: a high performance scheme for maintaining replicated data [[pdf](https://ieeexplore.ieee.org/abstract/document/180609)]
* How to Assign Votes in a Distributed System [[acmdl](https://dl.acm.org/citation.cfm?id=4223)]
* Hierarchical Quorum Consensus: A New Algorithm for Managing Replicated Data [[pdf](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=83661)]
* The Load, Capacity, and Availability of Quorum Systems [[pdf](https://epubs.siam.org/doi/pdf/10.1137/S0097539795281232)]
* A √N algorithm for mutual exclusion in decentralized systems [[acmdl](https://dl.acm.org/citation.cfm?id=214445)]
* The Availability of Quorum Systems [[pdf](https://pdfs.semanticscholar.org/ab7d/30f7a808173bc305d679262f9838869cb681.pdf)]
* Coterie Availability in Sites [[pdf](https://link.springer.com/chapter/10.1007/11561927_3)]
* The virtue of dependent failures in multi-site systems [[acmdl](https://dl.acm.org/citation.cfm?id=1973401)]
* Crumbling Walls: A Class of Practical and Efficient Quorum Systems [[pdf](https://link.springer.com/article/10.1007/s004460050027)]
